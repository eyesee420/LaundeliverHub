...
public class shopOwner_register_page extends AppCompatActivity {
    ...
    boolean is_shopowner = true;
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    Create_Users_Model createUsersModel;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shop_owner_register_page);
        ...
        register_user_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                createUsersModel = new Create_Users_Model(fullname ,adminphonenumber, currentaddress, emailaddress,
                        is_users, is_admins,is_shopowners);
...
//                                    //set the user id
                                    ...
                                    documentReference.set(createUsersModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(shopOwner_register_page.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(shopOwner_register_page.this, shopOwners_login_page.class);
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(shopOwner_register_page.this, "Failed to register", Toast.LENGTH_SHORT).show();
                                            progressBar.setVisibility(View.INVISIBLE);
                                        }
                                    });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(shopOwner_register_page.this , shopOwners_login_page.class));
        finish();
        }
}